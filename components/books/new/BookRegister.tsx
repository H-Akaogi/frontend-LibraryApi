                ...
                <form onSubmit={onSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            maxLength={50}
                        />
                        <p className="text-sm text-gray-500">1〜50文字</p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                maxLength={30}
                            />
                            <p className="text-sm text-gray-500">1〜30文字</p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                required
                            />
                            <p className="text-sm text-gray-500">0以上の整数</p>
                        </div>
                    </div>
